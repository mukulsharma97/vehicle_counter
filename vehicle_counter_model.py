...
labelsPath = os.path.sep.join([r"C:\examples\vehicle_count_assignment\Yolo-Vehicle-Counter-master\yolo-coco", "coco.names"])
LABELS = open(labelsPath).read().strip().split("\n")

# derive the paths to the YOLO weights and model configuration
weightsPath = os.path.sep.join([r"C:\examples\vehicle_count_assignment\Yolo-Vehicle-Counter-master\yolo-coco", "yolov3.weights"])
configPath = os.path.sep.join([r"C:\examples\vehicle_count_assignment\Yolo-Vehicle-Counter-master\yolo-coco", "yolov3.cfg"])

# inputs and required items
USE_GPU = False
videoname = "1615363610851"
inputVideoPath ="C:/examples/vehicle_count_assignment/Yolo-Vehicle-Counter-master/smaple video/"+videoname+".mp4"
outputVideoPath = "C:/examples/vehicle_count_assignment/Yolo-Vehicle-Counter-master/output/"+videoname+".mp4"
...
# True if the box was current box was present in the previous frames;
...
coy1 = int(input("enter y1 coordinates"))
coy2 = int(input("enter y2 coordinates"))
x1_line = 0
y1_line = coy1
x2_line = video_width
y2_line = coy2
...
while True:
	...
	# draw coordinate line on frame
	frame = cv2.line(frame,(x1_line,y1_line), (x2_line,y2_line),(255,0,0), 2)
